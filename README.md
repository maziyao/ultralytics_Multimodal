...
<h1>This project incorporates a multimodal approach to train remote sensing or autonomous driving. Currently, the input can accommodate two types of three-channel images, and the model can be trained and modified using the same methods as before.</h1>
